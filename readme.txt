...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\autotaggingextension on
     Windows, /home/user/dev/autotaggingextension on Linux) in a file named
     autotaggingextension@yono and copy that file to
